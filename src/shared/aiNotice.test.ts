...
describe('AI advisory presentation', () => {
  it('presents actionable advisories and keeps filesystem configuration warnings internal', () => {
    ...
    expect(describeAiNotice('Configured filesystem path `:project_roots/.modmind` is not recognized by this version of Codex and will be ignored. Upgrade Codex if this path is required.')).toBe('')
  })
