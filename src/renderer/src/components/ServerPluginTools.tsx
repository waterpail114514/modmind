...
export function ServerPluginSettings({ project, disabled }: { project: ProjectInfo; disabled: boolean }): React.JSX.Element {
  ...
  </div><div className="modpack-tool-actions"><label><input type="checkbox" checked={profile.onlineMode} onChange={event => patch({ onlineMode: event.target.checked })} /> 在线身份验证</label><a href="https://www.minecraft.net/eula" target="_blank" rel="noreferrer">Minecraft EULA</a></div>
