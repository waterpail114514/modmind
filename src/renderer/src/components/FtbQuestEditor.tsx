              ...
              <div ref={questDialog} className="dialog ftb-quest-book" role="dialog" aria-label="任务详情" aria-modal="true" onMouseDown={(event) => event.stopPropagation()}>
                ...
                <div className="ftb-quest-book-columns">
                  <div className="ftb-quest-book-column">
                    <div className="ftb-quest-book-col-title"><span>任务</span><select value="" aria-label="添加任务条件" onChange={(event) => { if (event.target.value) addTask(event.target.value); event.target.value = '' }}><option value="">＋ 添加</option>{TASK_TYPES.map((meta) => <option key={meta.value} value={meta.value}>{meta.label}</option>)}</select></div>
                  ...
                  <div className="ftb-quest-book-column">
                    <div className="ftb-quest-book-col-title"><span>奖励</span><select value="" aria-label="添加奖励" onChange={(event) => { if (event.target.value) addReward(event.target.value); event.target.value = '' }}><option value="">＋ 添加</option>{REWARD_TYPES.map((meta) => <option key={meta.value} value={meta.value}>{meta.label}</option>)}</select></div>
